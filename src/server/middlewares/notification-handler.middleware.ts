...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'playlist.create': {
    roles: ['owner', 'admin'],
    key: 'playlist-created',
    tenantPath: ['organization', 'playlist'],
    userPath: [],
  },
  'playlist.update': {
    roles: ['owner', 'admin'],
    key: 'playlist-updated',
    tenantPath: ['organization', 'playlist'],
    userPath: [],
  },
  'playlist.delete': {
    roles: ['owner', 'admin'],
    key: 'playlist-deleted',
    tenantPath: ['organization', 'playlist'],
    userPath: [],
  },
  'song.create': {
    roles: ['owner', 'admin'],
    key: 'song-added',
    tenantPath: ['organization', 'playlist', 'song'],
    userPath: [],
  },
  'song.update': {
    roles: ['owner', 'admin'],
