  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to App - Your Ultimate Destination for Endless Music, Curated Playlists and Personalized Experiences. Dive into a World Similar to Spotify, but Uniquely Yours."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtdXNpY3xlbnwwfHx8fDE2OTQ3ODc4MTl8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@marcelalaskoski?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Marcela Laskoski`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to App - Your Ultimate Destination for Endless Music, Curated Playlists and Personalized Experiences. Dive into a World Similar to Spotify, but Uniquely Yours.`}
            </Text>
            <Box
